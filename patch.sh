...
backup "${celeste_dir}/Celeste-arm64"
cat Celeste > "${celeste_dir}/Celeste-arm64"
chmod +x "${celeste_dir}/Celeste-arm64"
...
cp -H otherlibs/fmodstudioapi/api/studio/lib/arm64/libfmodstudio.so.13 "${celeste_dir}/lib-arm64/libfmodstudio_real.so"
...
cp -H fmod/sound/libfmodstudio.so "${celeste_dir}/lib-arm64/"
ln -s libfmod.so.13 "${celeste_dir}/lib-arm64/libfmod.so"
ln -s libfmod.so.13 "${celeste_dir}/lib-arm64/libfmod.so.10"
ln -s libfmodstudio_real.so "${celeste_dir}/lib-arm64/libfmodstudio.so.13"
ln -s libfmodstudio.so "${celeste_dir}/lib-arm64/libfmodstudio.so.10"
